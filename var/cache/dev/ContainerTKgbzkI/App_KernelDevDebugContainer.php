...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.exception', [0 => function () {
            return ($this->privates['app.exception_listener'] ?? $this->load('getApp_ExceptionListenerService'));
     ...
     */
    protected function get_ServiceLocator_HBWQRWzService()
    {
        return $this->privates['.service_locator.hBWQRWz'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('REwzaweYdP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($this->privates['.service_locator.hBWQRWz'] ?? $this->get_ServiceLocator_HBWQRWzService()), new RewindableGenerator(function () {
