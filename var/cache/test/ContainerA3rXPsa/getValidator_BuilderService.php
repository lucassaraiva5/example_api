 ...
 */
class getValidator_BuilderService extends App_KernelTestContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setMappingCache(($container->privates['validator.mapping.cache.adapter'] ?? $container->load('getValidator_Mapping_Cache_AdapterService')));
