...
class getNelmioApiDoc_Describers_ConfigService extends App_KernelTestContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['nelmio_api_doc.describers.config'] = new \Nelmio\ApiDocBundle\Describer\ExternalDocDescriber(['info' => ['title' => 'MoviesApi', 'description' => 'This is a example api to storage movies', 'version' => '1.0.0']]);
    }
}
